...
interface plotCardProps {
	plotObj: plotsProps
	openModal: (action : 'add' | 'edit' | 'delete', plotId: number) => void
}
		...
		<>
			<View style={getCardStyle(colorScheme, theme).cardHeaderView}>
				...
				<Menu
					...
					<Divider />
					<Menu.Item onPress={() => {closeMenu(); openModal('delete', plotObj.id || 0)}} title="Delete Plot" leadingIcon='delete' titleStyle={plotCardStyles.titleStyle}/>
				</Menu>
			</View>
